...
public class ScannerActivity extends AppCompatActivity implements ScannerCommunicationBus, ServiceConnection {
    ...
    static BtleService.LocalBinder serviceBinder;
    ...
    public void onDeviceSelected(final BluetoothDevice btDevice) {
        ...
        mwBoard.connectAsync()
                ...
                .continueWith(task -> {
                    if (!task.isCancelled()) {
                        if ((led1= mwBoard.getModule(Led.class)) != null) {
                            led1.editPattern(Led.Color.BLUE, Led.PatternPreset.BLINK)
                                    .repeatCount((byte) 5)
                                    .commit();
                            led1.play();
                        }
                        ...
                        Intent navActivityIntent = new Intent(ScannerActivity.this, ScannerActivity2.class);
