...
public abstract class SensorFragment extends ModuleFragmentBase {
        ...
        if (scrollView != null) {
            ...
            scrollView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    ...
                    LineChart.LayoutParams params2 = chart2.getLayoutParams();
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        chart2 = (LineChart) view.findViewById(R.id.data_chart2);
    ...
    protected void StartMath(){

}
    protected abstract void setup();
    protected abstract void clean();
    protected abstract float Sensor1();
    protected abstract float Sensor2();
    protected abstract void logstart();
    protected abstract void logstop();
