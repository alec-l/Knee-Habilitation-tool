...
public abstract class ModuleFragmentBase extends Fragment implements ServiceConnection {
    ...
    protected MetaWearBoard mwBoard2;
    protected FragmentBus fragBus;
    protected FragmentBus fragBus2;
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        mwBoard2= ((BtleService.LocalBinder) iBinder).getMetaWearBoard(fragBus2.getBtDevice());
        try {
            boardReady= true;
            boardReady();
        } catch (UnsupportedModuleException e) {
